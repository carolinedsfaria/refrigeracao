#Two-stage cycle with dual compressors
...
# Calculates two stage cycle (q_evaporators or work and x as inputs)
...
def generate_two_stage_cycle(input_values,input_ranges):
...
two_stage_table = generate_two_stage_cycle(input_values, input_ranges)
