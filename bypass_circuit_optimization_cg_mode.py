...
import copy
import os
from bypass_circuit_cycle_cg_mode import calculate_bypass_circuit_cycle
    ...
    for refrigerant in input_ranges['refrigerants']:
        for t_external in input_ranges['t_external']:
            ...
            results = results.append({
                ...
                'Grau de subresfriamento':optimized_cycle['cooling_FFC'],
...
optimized_table = optimize_bypass_circuit_cycle_with_multiple_refrigerants(input_values, 'cop', input_ranges)

# Create a Pandas Excel writer using XlsxWriter as the engine
writer = pd.ExcelWriter('bypass_cycle_optimization_cg_mode.xlsx', engine='xlsxwriter')
