...
import copy
import os
from parallel_circuit_cycle_cg_mode import calculate_parallel_circuit_cycle
...
writer = pd.ExcelWriter('parallel_cycle_optimization_cg_mode.xlsx', engine='xlsxwriter')
