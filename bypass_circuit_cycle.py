...
def calculate_bypass_circuit_cycle(cycle_inputs):
    ...
    if abs(Pl_sat-Pv_sat)>0: #mistura zeotrópica
    ...
    f=(cycle_inputs['t_external']-cycle_inputs['t_internal_env_ht'])/(cycle_inputs['t_external']-cycle_inputs['t_internal_env_lt'])
    q_evaporator_ht = cycle_inputs['q_evaporator_ht']
    q_evaporator_lt = cycle_inputs['q_evaporator_lt']

    q_evaporator_ffc_fzc=q_evaporator_ht+f*q_evaporator_lt
    m_ht = q_evaporator_ffc_fzc / (point_6['HMASS'] - point_5['HMASS'])
    work_ffc_fzc = m_ht * (point_2['HMASS'] - point_1['HMASS'])


    ### FZC CYCLE
    
    q_evaporator_fzc=(1-f)*q_evaporator_lt
    m_lt = (1-f)*q_evaporator_lt / (point_9['HMASS'] - point_8['HMASS'])
    work_fzc = m_lt * (point_11['HMASS'] - point_10['HMASS'])


    q_evaporator=q_evaporator_ffc_fzc+q_evaporator_fzc
    work=work_ffc_fzc+work_fzc
    ...
    w_carnot_ffc_fzc = q_evaporator_ffc_fzc / cop_carnot_ht
    w_carnot_fzc = q_evaporator_fzc / cop_carnot_lt
    
    cop_carnot = (q_evaporator) / (w_carnot_ffc_fzc + w_carnot_fzc)
    ...
    return {
        ...
        'compressor_exergy_destruction_lt':compressor_exergy_destruction_ht,
        ...
        'x5':point_5['Q'],
        'x8':point_8['Q'],
        'slhx_exergy_destruction_ht':slhx_exergy_destruction_ht,
        'slhx_exergy_destruction_lt':slhx_exergy_destruction_lt,
        'minimum_ad':min(compressor_exergy_destruction_ht,compressor_exergy_destruction_lt,condenser_exergy_destruction_ht,condenser_exergy_destruction_lt,expansion_valve_ht_exergy_destruction,expansion_valve_lt_exergy_destruction,evaporator_ht_exergy_destruction,evaporator_lt_exergy_destruction,slhx_exergy_destruction_ht,slhx_exergy_destruction_lt)
